        ...
        <div className="relative border-l border-border pl-6 space-y-8">
          <div className="relative">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm">
                All submissions must be received by 11:59 PM Pacific Time
                (UTC-7)
              </p>
            </div>
          </div>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              <div className="space-y-4">
                <p>
                  Each oral presentation will be allocated 15 minutes, followed
                  by 5 minutes for questions and answers.
                </p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Prepare slides in 16:9 format</li>
                  <li>
                    Upload your presentation at least 30 minutes before your
                    session
                  </li>
                  <li>
                    Include your paper title, authors, and affiliations on the
                    first slide
                  </li>
            ...
            <AccordionContent>
              <div className="space-y-4">
                <p>
                  ...
                  At least one author must be present during this time.
                </p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Maximum poster size: 36&quot; x 48&quot; (91cm x 122cm)
                  </li>
                  <li>Portrait orientation is recommended</li>
                  <li>
                    Set up your poster 30 minutes before the session starts
                  </li>
                  <li>Prepare a 2-minute elevator pitch for your work</li>
                  <li>
                    Consider bringing handouts or QR codes linking to your
                    paper/code
                  </li>
                </ul>
              </div>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              <div className="space-y-4">
                <p>
                  The following equipment will be provided for oral
                  presentations:
                </p>
                <ul className="list-disc pl-5 space-y-1">
                ...
                <p>
                  Please bring your own laptop or a USB drive with your
                  presentation.
                </p>
              </div>
            </AccordionContent>
